const texto_random_dificil="http://api.quotable.io/random?minLength=100"
...
function getHardQuote(){
    return fetch(texto_random_dificil)
        .then(response=>response.json())
        .then(data=>data.content)
}

async function getNextHard(){
    const quote=await getHardQuote()
